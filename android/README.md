...
```gradle
dependencies {
    implementation 'com.github.apiverve:translator-api:1.1.12'
}
```
...
```java
import com.apiverve.translator.TranslatorAPIClient;
import com.apiverve.translator.APIResponse;
import com.apiverve.translator.APIException;

// Initialize the client
TranslatorAPIClient client = new TranslatorAPIClient("YOUR_API_KEY");
...
For detailed API documentation, visit: [https://docs.apiverve.com/ref/translator](https://docs.apiverve.com/ref/translator)
...
- **Documentation:** [https://docs.apiverve.com/ref/translator](https://docs.apiverve.com/ref/translator)
- **Issues:** [GitHub Issues](https://github.com/apiverve/translator-api/issues)
