...
class translatorWrapper {
    ...
    constructor(options) {
        ...
        this.validationRules = {"text":{"type":"string","required":true},"target":{"type":"string","required":true},"source":{"type":"string","required":false}};
    }
    ...
    validateParams(query) {
        ...
        if (errors.length > 0) {
            throw new Error(`Validation failed: ${errors.join(' ')} See documentation: https://docs.apiverve.com/ref/translator`);
        }
    }
...
module.exports = translatorWrapper;
