...
namespace APIVerve.API.Translator
{
...
#endif
    {
        ...
        private static readonly Dictionary<string, ValidationRule> _validationRules = new Dictionary<string, ValidationRule>
        {
            ...
            { "target", new ValidationRule { Type = "string", Required = true } },
            { "source", new ValidationRule { Type = "string", Required = false } }
        };
        ...
        public TranslatorAPIClient(string apiKey)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TranslatorAPIClient(string apiKey, bool isSecure, bool isDebug)
#if NET45 || NETSTANDARD2_0 || NETSTANDARD2_1 || NET6_0
        ...
        /// <exception cref="ArgumentException">Thrown when API key is invalid</exception>
        public TranslatorAPIClient(string apiKey, bool isSecure, bool isDebug, HttpClient httpClient)
        {
        ...
        private void ValidateParams(TranslatorQueryOptions options)
        {
        ...
        public Task<ResponseObj> ExecuteAsync(TranslatorQueryOptions options = null)
        {
        ...
        public async Task<ResponseObj> ExecuteAsync(TranslatorQueryOptions options, CancellationToken cancellationToken)
        {
            int attempt = 0;
        ...
        /// </summary>
        private async Task<ResponseObj> ExecuteRequestAsync(TranslatorQueryOptions options, CancellationToken cancellationToken)
        {
            try
            {
        ...
        /// </summary>
        private ResponseObj ExecuteWithWebRequest(TranslatorQueryOptions options)
        {
            int attempt = 0;
            Exception lastException = null;
        ...
        /// </summary>
        private ResponseObj ExecuteWebRequestInternal(TranslatorQueryOptions options)
        {
            try
            {
                Log("Executing API request...");
